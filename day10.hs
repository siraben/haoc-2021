...
main = do
  ...
  print (sum $ map fst inp')
  let s = map (snd . badness) (filter (not . corrupted) inp) :: [String]
  print s
  let d = sort (map (part2) s)
  print d
  print (d !! (length d `div` 2))
  -- print (median $ map badness inp)
  -- print (part1 inp)
  -- print (part2 inp)
  -- defaultMain
  --   [ bgroup
